...
from apis.GetProductListAPI import GetProductListAPI
from state.ProductsDetailsReading import ProductsDetailsReading
class ProductDisplayState(State):
    ...
    def show_product_details(self):
        products = GetProductListAPI().getProductList()
        self._vending_machine.change_state(ProductsDetailsReading(self))
        return products
    ...
    def get_state_name(self) -> str:
        return VendingMachineState.PRODUCT_DISPLAY
